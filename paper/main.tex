...
model was trained on \needsnum{AUTHORS: name the one GPU the reported run used --- the
RTX 4050, the A100 or the T4 --- and the wall-clock time it took}.}
